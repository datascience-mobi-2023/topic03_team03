...
colnames(Sel_Crit_compare) = c("delta_mu", "Ctrl_heightprop", "RNAse_heightprop", "overlap", "Ctr_heightprop_compare", "RNase_heightprop_compare")
...
kmeans(shift_behavior, 4, iter.max = 10, nstart = 1)
