...
t.test(Sel_Crit[which(Sel_Crit[, 26] == "yes"), 27], Sel_Crit[which(Sel_Crit[, 26] == "no"), 27])$p.value
t.test(Sel_Crit[which(Sel_Crit[, 26] == "yes"), 27], Sel_Crit[which(Sel_Crit[, 26] == "partial"), 27])$p.value
t.test(Sel_Crit[which(Sel_Crit[, 26] == "partial"), 27], Sel_Crit[which(Sel_Crit[, 26] == "no"), 27])$p.value
```
