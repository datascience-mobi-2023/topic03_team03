...
legend("topright", legend = c("left", "right", "no"), pch = 16, col = c("blue", "red", "grey"))
...
# ---> kmeans-Clustering
kmeans = kmeans(pca$x[,1:2], 3, iter.max = 10, nstart = 1)
...
# ---> kmeans-Clustering
kmeans = kmeans(pca$x[,1:2], 2, iter.max = 10, nstart = 1)
