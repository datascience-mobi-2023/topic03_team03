...
sd(Sel_Crit[which(Sel_Crit[, 26] == "yes"), 27], na.rm = T)
sd(Sel_Crit[which(Sel_Crit[, 26] == "partial"), 27], na.rm = T)
sd(Sel_Crit[which(Sel_Crit[, 26] == "no"), 27], na.rm = T)
...
###### 5.3.5 Cluster Comparison with t-Test
