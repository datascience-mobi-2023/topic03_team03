...
Gene_Plotter(gene.name, col = c("green", "red", "dodgerblue", "darkorange"), main = TRUE, cus.main = NULL, ylab = "Relative Protein Amount", xlab = "Protein Fractions", fs = c(1.2, 1, 1), Leg.Size = 1, Leg.Pos = c(0, 0), mar = c(5, 4, 4, 7), Legend = TRUE, Ctrl = TRUE, RNase = TRUE, Gbl.Max = TRUE, Loc.Max = TRUE, Gauss = TRUE, conf = TRUE, grid = TRUE, Type = "Smooth and Norm")
