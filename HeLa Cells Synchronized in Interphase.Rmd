...
Gene_Plotter(gene.name, col = c("green", "red", "dodgerblue", "darkorange"), main = TRUE, ylab = "Relative Protein Amount", xlab = "Protein Fractions", fs = c(1.2, 1, 1), Leg.Size = 1, Leg.Pos = c(0, 0), mar = c(5, 4, 4, 7), Legend = TRUE, Ctrl = TRUE, RNase = TRUE, Gbl.Max = TRUE, Loc.Max = TRUE, Gauss = TRUE, conf = TRUE, grid = TRUE, Type = "Smooth and Norm")
...
Gene_Plotter <- function(gene.name, col = c("green", "red", "dodgerblue", "darkorange"), main = T, ylab = "Relative Protein Amount", xlab = "Protein Fractions", fs = c(1.2, 1, 1), Leg.Size =  1, Leg.Pos = c(0, 0), mar = c(5, 4, 4, 7), Legend = T, Ctrl = T, RNase = T, Gbl.Max = T, Loc.Max = T, Gauss = T, conf = T, grid = T, Type = "Smooth and Norm" #, "Norm", "Smooth", "Raw", "Compare"
                          ) {
library(scales)
...
plot(1:25, rep(NA, 25),xlab=xlab,ylab=ylab,main = if(main == T) {paste(gene.name[j], "(Smoothed and Normalized)")}, ylim=c(0, 1.1 * max(
...
plot(1:25, rep(NA, 25),xlab=xlab,ylab=ylab,main=if(main == T) {paste(gene.name[j], "(Normalized)")}, ylim=c(0, 1.1 * max(
...
plot(1:25, rep(NA, 25),xlab=xlab,ylab=ylab,main=if(main == T) {paste(gene.name[j], "(Smoothed)")}, ylim=c(0, 1.1 * max(
...
plot(1:25, rep(NA, 25),xlab=xlab,ylab=ylab,main=if(main == T) {paste(gene.name[j], "(Raw Data)")}, ylim=c(0, 1.1 * max(
...
plot(1:25, rep(NA, 25),xlab=xlab,ylab=ylab,main=if(main == T) {paste(gene.name[j], "(Norm/Smooth v. Norm)")}, ylim=c(0, 1.1 * max(
  if(Ctrl == T) {max(Ctrl_Mean_Norm100[which(rownames(Ctrl_Mean)==gene.name[j]),])}, 
  if(RNase == T) {max(RNase_Mean_Norm100[which(rownames(Ctrl_Mean)==gene.name[j]),])}, 
  if(Ctrl == T) {max(Ctrl_Mean_Smooth_Norm100[which(rownames(Ctrl_Mean)==gene.name[j]),])}, 
  if(RNase == T) {max(RNase_Mean_Smooth_Norm100[which(rownames(Ctrl_Mean)==gene.name[j]),])})),
