...
Mean_Ctrl_Loc_Max[, 3:23] = as.data.frame(sapply(seq(1,21,1), function(n) {
  replace(
...
Mean_RNase_Loc_Max[, 3:23] = as.data.frame(sapply(seq(1,21,1), function(n) {
  replace(
...
Mean_Ctrl_Loc_Max[, 2:23] = as.data.frame(sapply(seq(1,22,1), function(n) {
  replace(
        Mean_Ctrl_Loc_Max[, n+1], 
        Fra.Pos[[n]], 
        n+1.5)}))

Mean_Ctrl_Loc_Max[, 3:24] = as.data.frame(sapply(seq(1,22,1), function(n) {
  replace(
        Mean_Ctrl_Loc_Max[, n+2], 
        Fra.Pos[[n]], 
        NA)}))
...
Mean_RNase_Loc_Max[, 2:23] = as.data.frame(sapply(seq(1,22,1), function(n) {
  replace(
        Mean_RNase_Loc_Max[, n+1], 
        Fra.Pos[[n]], 
        n+1.5)}))

Mean_RNase_Loc_Max[, 3:24] = as.data.frame(sapply(seq(1,22,1), function(n) {
  replace(
        Mean_RNase_Loc_Max[, n+2], 
        Fra.Pos[[n]], 
        NA)}))
...
Mean_Ctrl_Loc_Max[, 1:23] = as.data.frame(sapply(seq(1,23,1), function(n) {
  replace(
        Mean_Ctrl_Loc_Max[, n], 
        Fra.Pos[[n]], 
        NA)}))

Mean_Ctrl_Loc_Max[, 3:25] = as.data.frame(sapply(seq(1,23,1), function(n) {
  replace(
        Mean_Ctrl_Loc_Max[, n+2], 
        Fra.Pos[[n]], 
        NA)}))
...
Mean_RNase_Loc_Max[, 1:23] = as.data.frame(sapply(seq(1,23,1), function(n) {
  replace(
        Mean_RNase_Loc_Max[, n], 
        Fra.Pos[[n]], 
        NA)}))

Mean_RNase_Loc_Max[, 3:25] = as.data.frame(sapply(seq(1,23,1), function(n) {
  replace(
        Mean_RNase_Loc_Max[, n+2], 
        Fra.Pos[[n]], 
        NA)}))
