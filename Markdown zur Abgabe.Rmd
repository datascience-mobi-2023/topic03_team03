...
```
\footnotesize  
**Figure A.1: PCA with Shifting Behavior.** Sample Text.\normalsize
...
```
\footnotesize  
**Figure A.2: PCA Densitiy Plots.** Sample Text.\normalsize
...
```
\footnotesize  
**Figure A.3: Application on Selection Criteria.** Sample Text.\normalsize
...
```
\footnotesize  
**Figure A.5: Linear Regression for Partial RDPs and Non RDPs.** Sample Text.\normalsize