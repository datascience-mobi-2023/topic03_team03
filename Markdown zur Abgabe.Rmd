...
In order to apply the obtained data on RDPs to biological questions, a linear regression was performed to evaluate how well of a predictor **binding affinity** is to **binding specificity** for RDPs. In this case, the binding affinity is defined as the protein amount difference between the Ctrl and RNase samples at the fraction position of the global Ctrl peak, and the binding specificity as the standard deviation at the global Ctrl peak.
