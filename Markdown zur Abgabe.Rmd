...
## 2.1 Referenced Data
The protocol for R-DeeP-Screening was performed on HeLa cells synchronized in interphase (Caudron-Herger *et al.*, 2020). This resulted in the dataframe *RDeep_HeLa_Interphase* in which the protein amounts per fraction were stored.
...
#### 2.6.3.4 Bar Plot  
For better visualization of the results a Bar plot were created.
