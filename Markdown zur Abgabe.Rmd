...
By calculating the **average RBP2GO-score** for each cluster identified by applying the optimal selection criteria, the RNA-dependence of a cluster was estimated. Using a two-sided t-Test. The significance of the differences between the mean values were calculated.The H0 and H1 hypotheses were defined as following: H0: The mean values are not significantly different from each other, H1: The mean values are significantly different from each other, with a False Positive Rate of 5%.
...
To determine the effectivess of our method, the proteins classified as RDPs in our analysis were compared to the proteins classified as RDPs in the RDP2Go database.. As depicted in *Fig.*, the RBP2GO-classified RDPs distribute homogeneously across the two clusters with no clear observable trend. 
...
To determine the significance of our clusters, the average RDP2Go score of these clusters was compared with a T-test. The average RDP2Go score of our RDPs is 21.5039 with a standard deviation of 19.8778, the average score of our partial RDPs is 13.57409 with a standard deviation of 15.59148 and the average score of our non-RDPs is 6.578844 with a standard deviation of 9.076432. For the comparison of the different clusters following p-values are calculated: RDP and non-RDP cluster:  p-value of $8.51824910^{-54}$, RDP and partial RDP cluster: p-value of $8.21350310^{-10}$, partial RDP and non RDP: p-value of $ 1.99911910^{-12}$. All clusters have significantly different p-values since each p-value is distinctly smaller than the Fals Positive Rate of $p=0,05$. 
